...
public class NumberTriangle {
    ...
    public static NumberTriangle loadTriangle(String fname) throws IOException {
        ...
        // will need to return the top of the NumberTriangle, so might want a variable for that.
        ...
        while (line != null) {
            ...
            if (prev == null) {
                ...
                // Put them into the current row
                String [] roots = line.split(" ");
                for (int i = 0; i < roots.length; i++) {
                    curr.add(new NumberTriangle(Integer.parseInt(roots[i])));
                }
